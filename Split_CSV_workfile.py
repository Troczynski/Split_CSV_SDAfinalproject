...
if __name__ == "__main__":
    ...
    print(f' faktyczna ilość wierzy{64-208}')
    print(f' indeks lini 63 początku i indeks lini końca 207')
    print(f'dodaj linie poczatku plus 144 =  {63+144}')
    print(f' ilośc wierzy danych w dobie 144')
